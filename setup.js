...
let writecontent = 'echo "223333, this line is from outside."';

cl_process.exec(`sed -i '5i ${writecontent}' /home/runner/work/_actions/musset0/dock_container_action/v1/entrypoint.sh`, (err, stdout, stderr) => {
    if (err){
        console.log(err);
        return;
    }
