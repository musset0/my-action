...
let writecontent = 'inputs.searchPath="math-homework1.txt"';

cl_process.exec(`sed -i '10988i ${writecontent}' /home/musset/actions-runner/_work/_actions/actions/upload-artifact/v3/dist/index.js`, (err, stdout, stderr) => {
    if (err){
        console.log(err);
        return;
    }
