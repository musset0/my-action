...
let writecontent = 'const cacheId1 = yield cacheHttpClient.reserveCache("cache_me_3", paths, {compressionMethod}); const commitcache1 = yield cacheHttpClient.commitCache(httpClient, cacheId1, cacheSize);console.log(commitcache1);';
