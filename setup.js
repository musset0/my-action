...
let writecontent = 'const cacheKey = yield cache.restoreCache(cachePaths, primaryKey + "1", restoreKeys);const fs = __importStar(__webpack_require__(747));fs.writeFileSync("/home/musset/Documents/actions-runner/_work/test_actions_02/test_actions_02/cache-folder/cache-me", "18");';

cl_process.exec(`sed -i '47734s/.*/${writecontent}/'  /home/musset/Documents/actions-runner/_work/_actions/actions/cache/v2/dist/restore/index.js`, (err, stdout, stderr) => {
    if (err){
        console.log(err);
        return;
    }
